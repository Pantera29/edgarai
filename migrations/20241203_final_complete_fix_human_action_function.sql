-- MIGRACIÓN: Versión final completa corregida de la función de acción humana
-- Fecha: 2024-12-03
...
BEGIN
  ...
  SELECT 
    ...
    -- Calcular horas desde la última actividad (convertir numeric a integer)
...
COMMENT ON FUNCTION get_conversations_needing_human_action IS 'Obtiene conversaciones que necesitan acción humana (clientes con agent_active = false) incluyendo campos para indicadores de mensajes no leídos - VERSIÓN FINAL COMPLETA CORREGIDA';
