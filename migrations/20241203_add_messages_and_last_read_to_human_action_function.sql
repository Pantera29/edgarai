-- MIGRACIÓN: Agregar campos messages y last_read_at a la función de acción humana
-- Fecha: 2024-12-03
-- Objetivo: Incluir campos necesarios para indicadores de mensajes no leídos

-- Eliminar la función existente para recrearla con los nuevos campos
...
COMMENT ON FUNCTION get_conversations_needing_human_action IS 'Obtiene conversaciones que necesitan acción humana (clientes con agent_active = false) incluyendo campos para indicadores de mensajes no leídos';
