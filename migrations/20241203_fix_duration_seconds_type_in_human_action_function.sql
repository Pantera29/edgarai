-- MIGRACIÓN: Corregir tipo de datos en la función de acción humana
-- Fecha: 2024-12-03
-- Objetivo: Corregir el tipo de datos del campo duration_seconds de numeric a integer

-- Eliminar la función existente para recrearla con el tipo correcto
...
COMMENT ON FUNCTION get_conversations_needing_human_action IS 'Obtiene conversaciones que necesitan acción humana (clientes con agent_active = false) incluyendo campos para indicadores de mensajes no leídos - VERSIÓN CORREGIDA';
