-- MIGRACIÓN: Versión completa corregida de la función de acción humana
-- Fecha: 2024-12-03
...
COMMENT ON FUNCTION get_conversations_needing_human_action IS 'Obtiene conversaciones que necesitan acción humana (clientes con agent_active = false) incluyendo campos para indicadores de mensajes no leídos - VERSIÓN COMPLETA CORREGIDA';
