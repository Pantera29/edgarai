-- MIGRACIÓN: Mantener compatibilidad con función original y agregar campos nuevos
-- Fecha: 2024-12-03
-- Objetivo: Agregar campos messages y last_read_at manteniendo la compatibilidad exacta

-- Eliminar la función existente para recrearla con compatibilidad
...
COMMENT ON FUNCTION get_conversations_needing_human_action IS 'Obtiene conversaciones que necesitan acción humana (clientes con agent_active = false) incluyendo campos para indicadores de mensajes no leídos - VERSIÓN COMPATIBLE';
