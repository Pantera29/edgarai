            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_monday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_tuesday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_wednesday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_thursday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_friday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_saturday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min="0"
                  max="50"
                  value={formData.max_slots_sunday || 0}
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
